...
\begin{frame}{Git terminology - Staging area}
  \center
  \includegraphics[height=3cm]{mail45.pdf}
...
\begin{frame}{Git terminology - Staging area}
  \center
  \includegraphics[height=2.7cm]{email26.pdf}
...
\begin{frame}{Introducing the tools}
  ...
  \huge Usually \mintinline{text}{nano} or \mintinline{text}{vim}
\end{frame}

\begin{frame}{Introducing the tools}
  \Huge \mintinline{text}{nano}:

  \begin{itemize}
    \item \Huge \mintinline{text}{CTRL+x} to save and quit
  \end{itemize}
\end{frame}

\begin{frame}{Introducing the tools - vim}
  \Huge \mintinline{text}{vim}:

  \begin{itemize}
    \item \Huge \mintinline{text}{INS} to enter ``Insert mode''
    \item \Huge \mintinline{text}{ESC} to leave ``Insert mode''
    \item \Huge \mintinline{text}{:wqRET} to save and quit
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Exercise 4: Fork a repository}
  \center
  \huge \mintinline{text}{fatal: destination path ...}
\end{frame}
...
\begin{frame}{Exercise 6: Branches}
  \begin{itemize}
    \item \Large Check out \mintinline{text}{bar}, add a file and commit it
    \item \Large Check out \mintinline{text}{master} and look for the file you just added
  \end{itemize}
\end{frame}
